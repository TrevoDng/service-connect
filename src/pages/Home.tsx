...
const Home: React.FC<HomeProps> = ({ setCurrentPage }) => {
  ...
  const handleGetStarted = (serviceId: string) => {
    // Navigate to login or service details
        ...
        <div className={styles.heroBackground}>
          <svg viewBox="0 0 1000 600" preserveAspectRatio="none">
            ...
            <circle 
              ...
              className={styles.floatingShapeReverse}
            />
            {/* Triangle */}
            <polygon 
              points="200,400 250,320 300,400" 
            ...
            {/* Rectangle */}
            <rect 
              x="700" y="350" width="80" height="80" 
              rx="10" 
            ...
            {/* Diamond */}
            <polygon 
              points="550,150 580,100 610,150 580,200" 
              fill="rgba(255,255,255,0.07)" 
              className={styles.floatingShapeReverse}
            ...
            <polygon 
              points="780,480 810,460 840,480 840,510 810,530 780,510" 
              fill="rgba(255,255,255,0.06)" 
              className={styles.floatingShapeReverse}
